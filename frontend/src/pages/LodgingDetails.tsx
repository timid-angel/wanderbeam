    ...
    <>
      ...
      <div className="about">
        ...
        <p>
          ...
          The {lodge.category} provides well-appointed rooms that cater to both
          business and leisure travelers, with essential amenities to ensure a
          pleasant stay. Guests can enjoy a variety of facilities, including a
          modest but delightful restaurant serving local and international
          cuisine. The hotel staff is friendly and dedicated to making your stay
          as comfortable as possible. Whether you're in Beach City for a quick
          business trip or a relaxed beach getaway, the {lodge.name} provides an
          affordable and convenient base for your stay.
        </p>
        <p>
